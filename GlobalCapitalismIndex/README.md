...
1. Cite the GCI (see [Citation](#citation)).
2. Cite the original data providers for any individual indicator you rely on.
   Every one of the 213 inputs is documented with a link to its source in the
...
External subject-expert reviews of each of the eight subindices.
